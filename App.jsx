...
const PRODUCTS = [
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1605333146440-10827299a91f?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1611082103901-70014022880c?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 3,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1615570050868-d70311f93f6b?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1620980486016-09a716c5264b?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 4,
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1517423568366-8b83523034fd?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 5,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1589416521014-99651aa3d32e?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 6,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1554188248-986adbb73be4?q=80&w=1000&auto=format&fit=crop",
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[110vh] flex items-center justify-center overflow-hidden bg-black">
        <div className="absolute inset-0 opacity-50 scale-110" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1533055640609-24b498dfd74c?q=80&w=1920&auto=format&fit=crop')`, backgroundPosition: 'center', backgroundSize: 'cover', transform: `translateY(${scrollPos * 0.4}px)` }} />
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto space-y-2">
                        ...
                        <button onClick={() => setCheckoutItems([{ ...product, qty: 1 }])} className="w-full bg-yellow-400 hover:bg-yellow-500 text-brand py-2 rounded-full font-bold text-sm transition-all shadow-sm">Beli Sekarang</button>
                      </div>
                    </div>
                  </motion.div>
                );
                      ...
                      <div className="flex justify-center gap-4 mt-6">
                        {[
                          ...
                          <button
                            ...
                            className={`px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all ${activeAngle === angle.key ? 'bg-brand text-white shadow-lg scale-105' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'}`}
                          >
                            {angle.label}
                          </button>
                        ))}
