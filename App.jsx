    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[110vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center px-4">
          <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-white text-5xl md:text-8xl font-black mb-4 tracking-tighter">TOPIKU TOPIMU</motion.h2>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="text-gray-300 text-lg md:text-2xl max-w-2xl mx-auto font-medium">Koleksi eksklusif untuk melengkapi gaya harianmu. TKTM hadir untuk kenyamanan dan estetika.</motion.p>
          <div className="mt-8">
            <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="#produk" className="inline-block bg-accent hover:bg-yellow-600 text-white font-bold py-4 px-10 rounded-full transition-all shadow-xl shadow-accent/20">Jelajahi Koleksi</motion.a>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    <div className="col-span-2">
                      <div className="flex gap-1">
                        ...
                        />
                        <button onClick={handleApplyPromo} className="bg-black hover:bg-zinc-800 text-white px-2 rounded-md font-bold text-[9px] whitespace-nowrap transition-colors">Pasang</button>
                      </div>
                    </div>
                    <div>
                      <input
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-1.5">
                      ...
                      />
                        <button onClick={handleApplyPromo} className="bg-black hover:bg-zinc-800 text-white px-3 rounded-xl font-bold text-[10px] whitespace-nowrap transition-colors">Pasang</button>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="flex gap-3 mt-6">
                        {['depan', 'samping', 'belakang'].map(angle => (
                          <button
                            ...
                            className={`flex-1 py-3 rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all ${activeAngle === angle ? 'bg-brand text-white shadow-lg scale-105' : 'bg-gray-100 text-gray-400 hover:bg-gray-200'}`}
                          >
                            {angle === 'depan' ? 'Tampak Depan' : angle === 'samping' ? 'Tampak Samping' : 'Tampak Belakang'}
                          </button>
                        ))}
                      </div>
                    </div>
