...
const PRODUCTS = [
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1633467815335-94ad7b6ca21b?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 3,
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?q=80&w=1000&auto=format&fit=crop",
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-square overflow-hidden cursor-pointer" onClick={() => { setSelectedProduct(product); }}>
                      ...
                      {product.terjual > 1000 && <div className="absolute top-4 left-4 bg-orange-500 text-white text-[10px] font-bold px-3 py-1 rounded-sm uppercase tracking-wider">TERLARIS</div>}
                    </div>
                        ...
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-10">
                          {['depan', 'samping', 'belakang'].map((angle) => (
                            <button
                              ...
                              className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${activeAngle === angle ? 'bg-accent text-white shadow-lg scale-110' : 'bg-white/80 text-brand hover:bg-white backdrop-blur-md'}`}
                            >
                              {angle}
                            </button>
                          ))}
