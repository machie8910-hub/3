...
const PRODUCTS = [
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1588850561407-ed78c282e89b?q=80&w=1000&auto=format&fit=crop&hue=100",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1575425186775-b8de9a427e67?q=80&w=1000&auto=format&fit=crop&hue=100",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1521369909029-2afed882baee?q=80&w=1000&auto=format&fit=crop&hue=100",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1618354691792-d1d42acfd860?q=80&w=1000&auto=format&fit=crop&hue=100",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1514327605112-b887c0e61c0a?q=80&w=1000&auto=format&fit=crop&hue=100",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1572307480813-ceb0e59d8325?q=80&w=1000&auto=format&fit=crop&hue=100",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1556306535-0f09a537f0a3?q=80&w=1000&auto=format&fit=crop&hue=100",
                      ...
                      <div className="flex gap-3 justify-center">
                        {['depan', 'samping', 'belakang'].map((angle) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all ${activeAngle === angle ? 'bg-accent text-white shadow-md' : 'bg-gray-100 text-gray-400 hover:bg-gray-200'}`}
                          >
                            {angle}
                          </button>
                        ))}
