...
const PRODUCTS = [
  {
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1523359366921-4c14294ff5df?q=80&w=1000&auto=format&fit=crop",
  ...
  },
  {
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1608231387042-66d1773070a5?q=80&w=1000&auto=format&fit=crop",
      samping: "https://images.unsplash.com/photo-1576431102949-8086208be16e?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 3,
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1533055640609-24b498dfd74c?q=80&w=1000&auto=format&fit=crop",
      samping: "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 4,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1514327605112-b887c0e61c0a?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 5,
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1565439386296-0884bbec494a?q=80&w=1000&auto=format&fit=crop",
  ...
  },
  {
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1000&auto=format&fit=crop",
      samping: "https://images.unsplash.com/photo-1488161628813-04466f872be2?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 7,
    ...
    images: {
      ...
      belakang: "https://images.unsplash.com/photo-1521369909029-2afed882baee?q=80&w=1000&auto=format&fit=crop",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1618354691792-d1d42acfd860?q=80&w=1000&auto=format&fit=crop"
    }
  }
];
...
const App = () => {
  ...
  const [currentAngle, setCurrentAngle] = useState('depan');
  ...
  return (
    <div className="min-h-screen parallax-wrapper">
      {/* Navbar */}
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="relative hidden md:block">
            <input
              ...
              className="bg-gray-100 rounded-full py-1.5 px-4 text-sm focus:outline-none focus:ring-2 ring-accent w-48 lg:w-64"
              value={search}
      ...
      <section className="relative h-[110vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center px-4" style={{ transform: `translateY(-${scrollPos * 0.1}px)` }}>
          <motion.h2 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-white text-5xl md:text-9xl font-black mb-6 tracking-tighter">TOPIKU TOPIMU</motion.h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative group max-w-4xl mx-auto">
            <div className="overflow-hidden rounded-[2.5rem] shadow-2xl">
              ...
              >
                {recs.map((product) => (
                  <div key={product.id} className="min-w-full relative aspect-[16/9] md:aspect-[2/1] overflow-hidden cursor-pointer" onClick={() => { setSelectedProduct(product); setCurrentAngle('depan'); }}>
          ...
          <motion.div layout className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatePresence mode='popLayout'>
              {filteredProducts.map(product => {
                return (
                  ...
                  >
                    <div className="relative aspect-square overflow-hidden cursor-pointer" onClick={() => { setSelectedProduct(product); setCurrentAngle('depan'); }}>
                      ...
                      {product.terjual > 1000 && (
                        <div className="absolute top-4 left-4 bg-orange-500 text-white text-[10px] font-bold px-3 py-1 rounded-sm uppercase tracking-tighter">
                          Terlaris
                        </div>
                      )}
                    </div>
                    <div className="p-5 flex-1 flex flex-col">
                      <div className="flex justify-between items-start mb-1">
                        ...
                        <p className="text-[10px] text-gray-400 font-medium italic">{product.terjual}+ terjual</p>
                      </div>
                      ...
                      <div className="mt-auto space-y-2">
                        ...
                        <button onClick={() => { setSelectedProduct(product); setCurrentAngle('depan'); }} className="w-full bg-yellow-400 hover:bg-yellow-500 text-brand py-2 rounded-full font-bold text-sm transition-all shadow-sm">Beli Sekarang</button>
                      </div>
                    </div>
                  </motion.div>
                );
            ...
            {filteredProducts.length === 0 && (
              <div className="col-span-full py-20 text-center">
                <LucideIcon name="search-x" className="w-16 h-16 text-gray-200 mx-auto mb-4" />
                <p className="text-gray-400 font-medium text-lg">Maaf, topi yang kamu cari tidak ditemukan.</p>
                <button onClick={() => {setSearch(""); setCategory("Semua");}} className="mt-4 text-accent font-bold hover:underline">Reset Pencarian</button>
              </div>
            )}
          </motion.div>
        </div>
              ...
              <div className="mb-8">
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Cari topi..."
                    className="w-full bg-gray-100 rounded-xl py-3 px-4 text-sm focus:outline-none ring-accent"
                    value={search}
                    onChange={(e) => setSearch(e.target.value)}
                  />
                  <LucideIcon name="search" className="absolute right-4 top-3 w-5 h-5 text-gray-400" />
                </div>
              </div>
      ...
      <AnimatePresence>
        {selectedProduct && (
          <>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => { setSelectedProduct(null); setCurrentAngle('depan'); }} className="fixed inset-0 bg-black/80 z-[100] backdrop-blur-md" />
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }} className="fixed inset-0 lg:inset-20 bg-white z-[110] lg:rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-2xl border border-gray-100">
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-12 bg-white">
                <div className="max-w-4xl mx-auto">
                  <button onClick={() => { setSelectedProduct(null); setCurrentAngle('depan'); }} className="mb-6 inline-flex items-center gap-1.5 text-[11px] font-bold text-accent hover:opacity-80 transition-opacity uppercase tracking-widest">
                      ...
                      <div className="relative aspect-video md:aspect-[21/9] overflow-hidden rounded-3xl shadow-2xl border border-gray-50 bg-gray-100">
                        <AnimatePresence mode="wait">
                          <motion.img
                            ...
                            exit={{ opacity: 0, x: -20 }}
                            transition={{ duration: 0.3 }}
                            src={selectedProduct.images[currentAngle]}
