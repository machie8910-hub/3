        ...
        {selectedProduct && (
          <>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }} className="fixed inset-0 lg:inset-20 bg-white z-[110] lg:rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-2xl border border-gray-100">
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="w-full">
                      <div className="relative aspect-video md:aspect-[21/9] overflow-hidden rounded-3xl shadow-2xl border border-gray-50 bg-gray-100">
                        ...
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 bg-white/20 backdrop-blur-md p-2 rounded-2xl border border-white/30">
                          {['depan', 'samping', 'belakang'].map(angle => (
                            <button
                              key={angle}
                              onClick={() => setActiveAngle(angle)}
                              className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-tighter transition-all ${activeAngle === angle ? 'bg-white text-brand shadow-lg scale-105' : 'text-white hover:bg-white/20'}`}
                            >
                      ...
                      <div className="mt-4 flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest justify-center">
                        <LucideIcon name="mouse-pointer-2" className="w-3 h-3" /> Ganti Sudut Pandang
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="col-span-2 bg-orange-50 p-4 rounded-2xl border border-orange-100 flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[10px] font-bold text-orange-400 uppercase tracking-widest">Populer</p>
                            <p className="text-sm font-black text-brand">{selectedProduct.terjual.toLocaleString('id-ID')}+ Produk Terjual</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="w-full lg:w-[320px] xl:w-[360px] bg-gray-50 p-6 md:p-8 lg:p-10 shrink-0 flex flex-col justify-center border-t lg:border-t-0 scrollbar-hide overflow-y-auto">
