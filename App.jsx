...
const PRODUCTS = [
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1594938374182-f8513c06b98e?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 2,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1631230445693-512b07049830?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1633467471850-7f28c2e39130?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 3,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1534215754734-18e55d13e346?q=80&w=1000&auto=format&fit=crop",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1589144865183-490326f582f4?q=80&w=1000&auto=format&fit=crop",
  ...
  },
  {
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1559070135-f259b369bf87?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1595164104031-15509930f3c5?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 6,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1533481405265-e9ce0c044abb?q=80&w=1000&auto=format&fit=crop",
      belakang: "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?q=80&w=1000&auto=format&fit=crop"
    }
  },
  {
    id: 7,
    ...
    images: {
      ...
      samping: "https://images.unsplash.com/photo-1553434390-a63e97072464?q=80&w=1000&auto=format&fit=crop",
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="w-full">
                      <div className="relative aspect-video md:aspect-[21/9] overflow-hidden rounded-3xl shadow-2xl border border-gray-50 bg-gray-100">
                        ...
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2 glass p-2 rounded-2xl">
                          {["depan", "samping", "belakang"].map((angle) => (
                            <button
                              key={angle}
                              onClick={() => setActiveAngle(angle)}
                              className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${activeAngle === angle ? 'bg-accent text-white shadow-lg' : 'bg-white/50 text-brand hover:bg-white'}`}
                            >
                              {angle}
                            </button>
                          ))}
